<%-- 
    Document   : customer
    Created on : Jan 26, 2021, 3:16:34 PM
    Author     : Satisfying
--%>
		...
		<tbody>
			...
			<tr>
				...
				<td><%=rs.getString("no_telp")%> </td>
                                <td><%=rs.getString("alamat_email")%></td>
                                <td><%=rs.getString("hak_akses")%></td>
                                <td style="">
                                    <a href="Backend/hapus_customer.jsp?id_customer=<%=rs.getString("id_customer")%>" class="btn btn-outline-danger">Hapus</a>
                                    <a href="edit_customer.jsp?id_customer=<%=rs.getString("id_customer")%>" class="btn btn-group">Edit Data</a>
                                </td>
