<%-- 
    ...
    Created on : Jan 26, 2021, 7:41:34 PM
    Author     : Satisfying
--%>
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                   ...
                   <%
                    ...
                    %>
                    <%if (rs.next()) {%>
                    <form method="post" enctype="multipart/form-data" action="Backend/edit_lapangan.jsp?id_lapangan=<%=rs.getString("id_lapangan")%>">
                       
                        <div class="form-group">
                            <label>Nama Customer</label>
                            <input type="text" class="form-control" name="nama_lapangan" value="<%=rs.getString("nama_lapangan")%>">
                        </div>
                        <br>
                        <button class="btn btn-danger" name="button">Ubah</button>
                        <button class="btn btn-primary" ><a href="lapangan.jsp" style="color:#FFFFFF">Cancel</a></button>
                    </form>
